...
* In the project directory, you can run:
  ...
  - Then, run the following command on the root project's directory to run the application:
  ```
  $ npm start
  ```
...
To test the application, run the following command on the root project's directory:
 ```
  $ npm test
  ```
